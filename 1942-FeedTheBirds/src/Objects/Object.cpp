...
Object::Object(const std::string& imgPath) {
	...
	//{
		//oSprite.reset(new Sprite());
		//PropertyList::Group* imagelist = properties().getGroup("images");
		//if (imagelist)
			//for (auto img = imagelist->cbegin(); img != imagelist->cend(); ++img)
		//	{
		...
		//throw Failure();
		//}
		//oSprite->setImage(image("default")); // may be null
	//}
	//else // load as image with default properties
	//{
		//oSprite.reset(new Sprite(imgPath));
//	}
	//updateSprite();
